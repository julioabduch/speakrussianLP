<template>
  <div class="fixed bottom-6 right-6 z-50">
    ...
    <!-- Tooltip -->
    <div class="absolute bottom-16 right-0 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
...
const props = defineProps({
  phoneNumber: {
    type: String,
    default: '+5541992152505'
  },
  message: {
    type: String,
    default: 'Olá! Gostaria de saber mais sobre o curso Speak Russian.'
  }
})
...
<style scoped>
/* Animação personalizada para o efeito de pulso */
@keyframes ping {
  75%, 100% {
    transform: scale(2);
    opacity: 0;
